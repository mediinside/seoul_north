...
require_once dirname(__FILE__) . '/PHPExcel/Shared/trend/linearBestFitClass.php';
require_once dirname(__FILE__) . '/PHPExcel/Shared/trend/logarithmicBestFitClass.php';
require_once dirname(__FILE__) . '/PHPExcel/Shared/trend/exponentialBestFitClass.php';
require_once dirname(__FILE__) . '/PHPExcel/Shared/trend/powerBestFitClass.php';
require_once dirname(__FILE__) . '/PHPExcel/Shared/trend/polynomialBestFitClass.php';
