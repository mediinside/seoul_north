...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>업무협력 기관 등록</strong></span>
		</div>
		<form name="base_form" id="base_form" method="POST" action="?" enctype="multipart/form-data">
		<input type="hidden" name="mode" id="mode" value="MULTI_REG" />
        <input type="hidden" name="tm_menu" id="tm_menu" value="organization" />
					...
					<table class="table table-bordered">
						<tbody>                         												          														                       
                            ...
                            <!--tr id="mobile_img">
								...
								<td>
									<input type="file" name="tm_m_img" id="tm_m_img" size="30" class="input_text"><span id="size_m"></span> (720 X 574)
								</td>
							</tr-->                                                                                                    
                            <tr>
