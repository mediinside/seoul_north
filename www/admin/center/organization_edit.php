...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		<div class="boxContentHeader">
			<span class="boxTopNav"><strong>업무협력 기관 수정</strong></span>
		</div>
					...
					<table class="table table-bordered">
						<tbody>                                         
                            ...
                            <!--tr>
                                ...
                                <td>
                                    <input type="file" name="tm_m_img" id="tm_m_img" size="30"><span id="size_m"></span>(720 X 574)
                                    <?
                                        if($tm_m_img != "") {
                                            echo  "<br>" . $tm_m_img;
                                    ?>
                                        <a href="#" onClick="img_del('<?=$tm_m_img;?>','<?=$_GET['tm_idx']?>','M')">(X)</a>
                                    <? } ?>
                                </td>
                            </tr-->                                      
							<tr>
...
<script type="text/javascript">
	...
	function img_del(image, idx, type)
	{
		...
		$.ajax({
			...
			data: "mode=MULTI_IMGDEL&tm_idx=" + idx + "&file=" + image + "&type=" + type,
			dataType: "text",
