<?		
	$jb_etc4 = substr($jb_etc4, 0, -1); 	
	$jb_etc5 = substr($jb_etc5, 0, -1); 
					...
					<table width="100%" class="viewType">
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="tit">전화번호</span> <strong class="mg-l10"><?=$jb_etc1?></strong></td>
								<td><span class="tit">작성일</span> <strong class="mg-l10"><?=$jb_reg_date?></strong></td>
							</tr>							
							<tr>
								<td style="text-align:left;" colspan="3">
                                <span class="tit">구분</span> <?=$jb_etc2?>									
								</td>
							</tr>	
							<tr>
								<td style="text-align:left;" colspan="3">
                                <span class="tit">거주지역</span> <?=$jb_etc3?>									
								</td>
							</tr>	
							<tr>
								<td style="text-align:left;" colspan="3">
                                <span class="tit">장애유형</span> <?=$jb_etc4?>									
								</td>
							</tr>	
							<tr>
								<td style="text-align:left;" colspan="3">
                                <span class="tit">신청내용</span> <?=$jb_etc5?>									
								</td>
							</tr>							
							<tr>
								<td style="text-align:left;" colspan="3">
